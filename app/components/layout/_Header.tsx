...
export default function Header() {
  ...
  return (
<header className=" fixed top-0 w-full z-50 bg-white/100 backdrop-blur-2xl border-b border-neutral-200 shadow-sm transition-all duration-300">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="nav-logo flex items-center">
            <Image
              ...
              height={40}
              priority
              className="h-12 sm:h-32 md:h-28 lg:h-40 w-auto object-contain"
            />
          </Link>
