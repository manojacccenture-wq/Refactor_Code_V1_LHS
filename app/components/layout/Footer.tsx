      ...
      <div className="max-w-7xl text-left mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16 lg:gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Link href="/" className="w-fit">
              <Image
                ...
                height={60}
                priority
                className="object-contain h-auto w-48 md:w-56" // Scaled size without breaking layout
              />
            </Link>

            {/* Description */}
            <p className="text-neutral-100-token  leading-relaxed max-w-xs">
              Building practical systems that work in the real world.
            </p>

            {/* Social Icons */}
            <div className="flex gap-6 items-center">
              <a href="#" aria-label="Facebook" className="text-neutral-100-token hover:text-primary transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" aria-label="X (Twitter)" className="text-neutral-100-token hover:text-primary transition-colors">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a href="#" aria-label="Instagram" className="text-neutral-100-token hover:text-primary transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/livelihood-system" target="blank" aria-label="LinkedIn" className="text-neutral-100-token hover:text-primary transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/@LHS-LivelihoodSystem" aria-label="YouTube" target="blank" className="text-neutral-100-token hover:text-primary transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-10">
            <h3 className=" font-bold-token text-neutral-100-token">Resources</h3>
            <nav className="flex flex-col gap-5 text-neutral-100-token">
          ...
          {/* COMPANY COLUMN */}
          <div className="flex flex-col gap-10">
            <h3 className=" font-bold-token text-neutral-100-token">Company</h3>
            <nav className="flex flex-col gap-5 text-neutral-100-token">
          ...
          {/* PRODUCTS COLUMN */}
          {/* <div className="flex flex-col gap-10">
            <h3 className="text-xl font-bold text-neutral-100-token">Products</h3>
            <nav className="flex flex-col gap-5 text-neutral-100-token">
          ...
          <div className="flex flex-col gap-10 lg:col-span-2">
            <h3 className=" font-bold-token text-neutral-100-token">Contact us</h3>
        ...
        {/* FOOTER BOTTOM */}
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 text-neutral-100-token text-lg">
          <p className="text-neutral-100-token">Copyright © 2026 Livelihood System</p>
          <div className="flex gap-2 flex-wrap">
            <span>All Rights Reserved |</span>
            <Link href="#" className="text-neutral-100-tokens hover:underline">
