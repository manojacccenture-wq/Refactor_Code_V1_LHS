...
export default function DeliveryHero() {
  return (
    <section className="w-full py-22 px-6 relative bg-gradient-to-b from-primary/5 to-transparent ">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-6 items-center text-center">
          {/* Subtitle */}
          <p className="text-primary  font-semibold-token tracking-widest uppercase mx-auto">FROM CONCEPT TO EXECUTION</p>

          {/* Main Heading */}
          <h1 className=" font-bold-token leading-[60px] max-w-2xl mx-auto">
