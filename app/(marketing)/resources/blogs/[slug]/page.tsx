...
export async function generateMetadata(
  ...
  return genMeta({
    ...
    // Use author image as OG image when available; falls back to site default
    image: blog.authorImage ? `${SITE_URL}${blog.authorImage.startsWith("/") ? blog.authorImage : "/" + blog.authorImage}` : undefined,
